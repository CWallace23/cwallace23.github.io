...
**Supervisor:** Clare Wallace

**Research area:** Probability

**Type of project:** Theoretical. There's scope for quite a lot of programming/computation here, but it *is not my area* and I can't guarantee I'll be able to help you troubleshoot.
...
The first part of this project will be based on reading textbooks and research papers, with a focus on a rigourous theoretical understanding of the topic. In the second part, the default will be to continue with this approach, but students may choose to build a computational model, apply it to a dataset they have found, and interpret their results.

Students will evidence their understanding of the topic by exploring real-world examples of small-world scenarios; discussing results and/or examples from the literature studied in more depth; considering theoretical implications of model choices; and/or by constructing computational models reflecting the theoretical considerations discussed. This understanding will be demonstrated through clear exposition and explanations in the written report and oral presentation.
